...
| 2.9 | Nova tela **Settings → Store Connections** — conecte sua conta Apple App Store Connect de verdade (Issuer ID/Key ID/Team ID/Private Key), valide a conexão e veja seus Apps reais. Validação com credenciais reais da Apple ainda não confirmada (sem conta de teste disponível) — infraestrutura pronta, aguardando credencial real |
