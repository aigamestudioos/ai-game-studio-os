...
export type { BuildWithDetails, BuildWithGameDetails } from "./repositories/builds-repository";
...
export type { ReleaseWithGameDetails } from "./repositories/releases-repository";
