...
// requisito).
//
// Nunca importar este módulo em código que roda no browser — SUPABASE_SERVICE_ROLE_KEY
// nunca deve chegar ao cliente (AGSOS-SPEC-004 §13: "proibido armazenar secrets no cliente").
export function createAdminClient() {
  if (typeof window !== "undefined") {
    throw new Error("admin-client não pode ser usado no browser — vazaria a service role key.");
  }
