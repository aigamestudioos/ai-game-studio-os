...
-- também insere estas 3 linhas (backfill de produção, onde seed.sql nunca
...
-- com gate de permissão, só nunca tinha sido exercitado antes porque os
-- sprints anteriores que testavam permissão usavam um Studio à parte.
